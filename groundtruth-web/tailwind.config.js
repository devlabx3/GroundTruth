...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      maxWidth: {
        prose: '68ch',
        // Ancho de contenido de los paneles (Admin y operador): amplio pero acotado,
        // para que en monitores grandes las tablas y el mapa tengan holgura sin estirarse
        // sin fin. La cabecera y el contenido se centran a este mismo ancho.
        panel: '90rem', // 1440px
      },
    },
  },
